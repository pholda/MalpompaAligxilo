...
object Generator extends JSApp {
  ...
  implicit def str2fieldName(str: String): FieldName = FieldName(str)
...
//      "http://192.168.56.101/aligxilo/AligxiloTest.php",
      "http://pej.pl/malpompaaligxilo/AligxiloTest.php",
      ...
      Field(
        ...
        placeholder = Some(I18nString("eo" -> "en internacia formo, ekz. +36 ...")),
      ...
      Field(
        ...
        visible = _.getFieldValue("mangxtipo") == "speciala",
        `type` = StringField()
      ),
      Field(
        name = "mangxoTipo2",
        caption = I18nString("eo" -> "Mi volas havi…"),
        visible = _.getFieldValue("mangxtipo") == "viande",
        `type` = SelectField(
          options = List(
