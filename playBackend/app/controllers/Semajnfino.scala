...
import pl.pej.malpompaligxilo.form.field.{TableCheckBoxRow, TableCheckBoxCol, EnumOption}
import pl.pej.malpompaligxilo.form.{FailureValidation, SuccessValidation}
